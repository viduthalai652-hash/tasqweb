...
# Inline SVG logo - renders using page fonts (Baloo 2 already loaded)
inline_svg_logo = '''<a href="index.html" class="nav-logo" style="text-decoration:none;display:flex;align-items:center;">
...
# Old logo patterns to replace (both possible versions)
old_patterns = [
    # HTML/CSS text logo
...
for fname in html_files:
    ...
    for old in old_patterns:
        if old in updated:
            updated = updated.replace(old, inline_svg_logo)
