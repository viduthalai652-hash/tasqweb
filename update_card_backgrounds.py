...
for i, service in enumerate(services_data):
    ...
    <div class="feature-showcase-card{reverse_class} reveal reveal-delay-{(i%3)+1}" style="background: linear-gradient(135deg, rgba(255, 255, 255, 0.93), rgba(250, 249, 246, 0.96)), url('assets/images/{service["img"]}') center/cover no-repeat;">
...
if start_idx != -1 and end_idx != -1:
    ...
    with open('features.html', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("Updated features.html with card background images successfully.")
else:
